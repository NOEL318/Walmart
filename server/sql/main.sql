...
('Samsung México', 'Parque Industrial Samsung, Querétaro', '5551234567', 'ventas@samsung.com'),
('Bimbo', 'Calle Panadería #9, CDMX', '5559876543', 'contacto@bimbo.com.mx');

-- PRODUCTOS
INSERT INTO Productos (id_producto, nombre, descripcion, precio_unitario, id_categoria, min_stock) VALUES
('44444444-4444-4444-4444-444444444441', 'Televisor 55" 4K', 'Smart TV Samsung UHD', 9999.99, '6ab46df1-1578-11f0-880e-ee5fda9bf999', 10),
('44444444-4444-4444-4444-444444444442', 'Pan de caja', 'Pan blanco rebanado Bimbo', 39.50, '6ab6d731-1578-11f0-880e-ee5fda9bf999', 100),
('44444444-4444-4444-4444-444444444443', 'Detergente líquido', 'Detergente para ropa 5L', 89.90, '6ab6dd2d-1578-11f0-880e-ee5fda9bf999', 50);
